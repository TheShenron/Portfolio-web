        ...
        <>
            <Box width={['95%', '90%']} m='auto' my='20px' mb='80px' id='Contact'>
                ...
                <Flex gap='10px' mt='25px'>
                    ...
                    <Link _hover={{textDecor:"none" , color:"#ef6817"}} href='https://drive.google.com/file/d/1DLwxuGQnKojzSAOcjgqF0TqZsZAG4R0M/view?usp=sharing' target='_blank'> <Flex gap='2' alignItems='center'> <Icon as={FaFilePdf} fontSize={['3xl' ,'3xl']} /> Resume</Flex> </Link>
                </Flex>
